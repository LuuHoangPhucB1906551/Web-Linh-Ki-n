<div class="purchase-nav-control">
    <a href="?type=0">Chờ xác nhận</a>
    <a href="?type=1" class="active">Đang giao</a>
    <a href="?type=2">Đã giao</a>
</div>
<div class="purchase-section">
    <?php
        $customerID = Session::get('customer_id');
        $getOrder = $cart->get_purchase_order($customerID, 1);
        if (!$getOrder) {
    ?>
    ...
    <div class="purchase-list">
        ...
        <div class="purchase-item">
            ...
            <div class="purchase-item__control">
                <div class="button">
                    <a href="?type=1&confirmID=<?php echo $customerID; ?>&price=<?php echo $result['price']; ?>&time=<?php echo $result['dateOrder']; ?>" class="primary">Đã nhận được hàng</a>
                </div>
                <div class="button">
