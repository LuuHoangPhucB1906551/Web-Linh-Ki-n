                    ...
                    <table id="myTable">
                        <thead>
                            <tr>
                                ...
                                <th class="w-15 sort">Tên Danh Mục</th>
                                <th class="w-10">Ảnh Danh Mục</th>
                            ...
                            ?>
                                    <tr id="id<?php echo $result['categoryID']; ?>">
                                        ...
                                        <td class="w-10 control">
                                            <a class="b-r" href="categoryedit.php?editID=<?php echo $result['categoryID']; ?>">Sửa</a>
                                            <a class="b-l" onclick="return confirm('Are you want to delete?')" href="?deleteID=<?php echo $result['categoryID']; ?>&url=<?php echo urlencode($result['categoryImage']); ?>">Xoá</a>
                                        </td>
                                    </tr>
                            <?php }
                            } ?>
