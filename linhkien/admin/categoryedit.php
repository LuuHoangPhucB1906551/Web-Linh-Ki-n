            ...
            <div class="card-form">
                ...
                <form action="" method="post" class="form" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" name="categoryName" class="form-control" placeholder="Nhập vào Tên Danh Mục..." value="<?php echo $result['categoryName']; ?>" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <a class="back" href="categorylist.php#id<?php echo $editID; ?>">Quay Về</a>
                    </div>
                </form>
                <?php } } ?>
            </div>
