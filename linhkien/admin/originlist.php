                    ...
                    <table id="myTable">
                        <thead>
                            <tr>
                                ...
                                <th class="w-15 sort">Nơi Xuất Xứ</th>
                            ...
                            ?>
                                    <tr id="id<?php echo $result['originID']; ?>">
                                        ...
                                        <td class="w-10 control">
                                            <a class="b-r" href="originedit.php?editID=<?php echo $result['originID']; ?>">Sửa</a>
                                            <a class="b-l" onclick="return confirm('Are you want to delete?')" href="?deleteID=<?php echo $result['originID']; ?>">Xoá</a>
                                        </td>
                                    </tr>
                            <?php }
                            } ?>
